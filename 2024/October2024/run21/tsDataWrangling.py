...
class tsDataWrangling:
    ...
    def step2_wrangle(self):
        ...
        df_copy_before            = self.res.copy()
        df_copy_before            = self.step2_add_dates_to_processed_data(  df_copy_before  )
        df_copy_before.to_csv('S1_df_copy_before.csv')
        ...
        self.dates_df_res_shifted.to_csv('S2_df_copy_after_shift_before_deltas.csv')
    ...
    def step3_wrangle(self):
        ...
        self.for_RNN_data_CIVS.to_csv('S3_FINAL_after_deltas.csv')
