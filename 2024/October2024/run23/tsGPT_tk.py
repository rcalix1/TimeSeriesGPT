...
class ParamsGPT:
    ...
    def __init__(self):
        ...
        self.block_size        = 10  ## 30   ## 15      ##   40      ## N tokens in sequence
        self.batch_size        = 16  ## 64 ## 16 
        self.max_iters         = 1500   ## 200  ## 3000
        self.eval_interval     = 200     
        self.learning_rate     = 1e-3   ##  0.0001        ## 1e-3
        self.eval_iters        = 300
        self.vocab_size        = 88  
        ## every id for a given token is embedded to vector of this size
        self.n_embd            = 512       ## 24        ## 512       ## 24 for time series, silicon is 0           
        self.n_head            = 16        ## 8         ## 8 attention heads
