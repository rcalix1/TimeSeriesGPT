...
class ParamsGPT:
    ...
    def __init__(self):
        ...
        self.batch_size        = 1024  ## 64 ## 16 ## 1024
    ...
    def random_4_runs( self ):
        ...
        train_CIVS           = sliced_chunk_CIVS[   : -n ] 
        test_CIVS            = sliced_chunk_CIVS[ -n:   ]
        chunk000to1000_train = train_CIVS[      :  ]
        
        return chunk300to400_train, chunk200to400_train, chunk100to400_train, chunk000to400_train, chunk000to500_train, chunk000to1000_train, test_CIVS
